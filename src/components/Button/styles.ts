...
export const ButtonStyle = styled.TouchableOpacity<VariantProps>`
  ...
  background-color: ${({ theme, variant }) => variant === 'fim' ? theme.colors.shape : theme.colors.primary};
...
export const Title = styled.Text<VariantProps>`
   ...
   color: ${({ theme, variant }) => variant === 'fim' ? theme.colors.primary : theme.colors.shape};
